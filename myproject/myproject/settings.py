...
SECRET_KEY = 'django-insecure-^6@q=#_=&20t%ww4$by1pmx094(5nt0^7**moo(t^dj#o-w%(1'
...
DATABASES = {
    'default': {
        ...
        'HOST': env("DB_HOST"),  # your database host, default to localhost
        'PORT': env("DB_PORT"),      # your database port, default to 5432
    }
}
